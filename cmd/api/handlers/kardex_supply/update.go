...
func (ksh *KardexSupplyHandler) Update(c echo.Context) error {
	...
	//Send to the service
	code_err, err := ksh.KardexSupplyService.Update(idkardex, full_name, input_kardex_supply)
	if err != nil {
